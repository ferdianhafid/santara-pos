...
export function exportReportCsv(context: ExportContext) {
  ...
  const rows: CsvValue[][] = [
    ...
    [],
    ['Expense List'],
    ['Date', 'Name', 'Category', 'Quantity', 'Unit', 'Amount', 'Payment Method', 'Notes'],
    ...
    ['Opening Cash', context.report.dailyClosing?.openingCash],
    ['Cash Sales', context.report.dailyClosing?.cashSales],
    ['QRIS Sales', context.report.dailyClosing?.qrisSales],
    ['Debit Sales', context.report.dailyClosing?.debitSales],
    ['Grab Sales', context.report.dailyClosing?.grabSales],
    ['Shopee Sales', context.report.dailyClosing?.shopeeSales],
